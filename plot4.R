...
plot(household_power_consumption$Time, household_power_consumption$Voltage, type="l", ylab = "Voltage", xlab="datetime")
...
plot(household_power_consumption$Time, household_power_consumption$Global_reactive_power, type="l", ylab = "Global_reactive_power", xlab="datetime")
